import { Dataset, RowStatus, FieldStatus, RfiComments, MultiSheetGlossaryConfig, MultiSheetGlossary, ModificationHistory, AnalystRemarks, AnomalyMap, BlacklistEntry } from '../types';
...
class StorageService {
  ...
  async createProject(dataset: Dataset, modificationHistory: ModificationHistory = {}, anomalyMap: AnomalyMap = {}): Promise<StoredProject> {
