...
import { parseGlossaryXLSX, parseFileWithNormalization } from './utils/fileParser';
...
function App() {
  ...
  }, [currentProjectId, appState, rfiComments, modificationHistory, analystRemarks, anomalyMap, glossaryState]);
  ...
  return (
    <div className="flex h-screen bg-slate-100">
      <Sidebar
        ...
        blacklistEntryCount={blacklistEntries.length}
